export function GoogleMap() {
  // Maps are defined in lib/company.ts — update embeds there
  const offices = [
    {
      label: "Dubai Office — UAE",
      sublabel: "ACICO Business Park, Dubai",
      embed:
    ...
    {
      label: "Lahore Office — Pakistan",
      sublabel: "Plot 107, Block C1, Engineers Town, Lahore",
      embed:
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {offices.map((office) => (
            <div key={office.label} className="bg-white shadow-lg overflow-hidden">
              <div className="bg-[#ff4800] px-5 py-3 flex items-center space-x-2">
                ...
                <div>
                  <h3 className="text-white font-bold text-sm">{office.label}</h3>
                  <p className="text-orange-100 text-xs">{office.sublabel}</p>
                </div>
              </div>
