export function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/971566569927?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20your%20logistics%20services."
      target="_blank"
      rel="noreferrer"
      aria-label="Chat with Triport Logistics on WhatsApp"
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-110 hover:bg-[#20bd5a] focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
    >
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 animate-ping rounded-full bg-[#25D366] [animation-duration:2.5s] motion-reduce:animate-none"
      />
      <svg viewBox="0 0 24 24" aria-hidden="true" className="relative z-10 h-8 w-8 fill-current">
